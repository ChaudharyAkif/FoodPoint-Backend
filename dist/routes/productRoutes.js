...
import { createProductsAndHandleDeal, updateProduct, getProductById, getAllProducts, } from '../controllers/productController';
...
router.patch('/:id/restock', async (req, res) => {
    try {
        ...
        const updatedProduct = await Product.findByIdAndUpdate(req.params.id, { $inc: { quantity: amount } }, { new: true });
