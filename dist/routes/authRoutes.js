...
router.get("/cashiers", authMiddleware, roleMiddleware("superadmin"), getAllCashiers);
router.get("/cashiers/:id", authMiddleware, roleMiddleware("superadmin"), getCashierById);
router.put("/cashiers/:id", authMiddleware, roleMiddleware("superadmin"), updateCashier);
router.delete("/cashiers/:id", authMiddleware, roleMiddleware("superadmin"), deleteCashier);
